package com.products.www.altentest.handler;
...
import com.products.www.altentest.dto.ErrorDTO;
...
public class ProductServiceExceptionHandler {
    ...
    public APIResponse<?> handleProductIdAccessException(ProductAccessDeniedException exception){
        APIResponse<?> serviceResponse = new APIResponse<>();
        serviceResponse.setStatus("ACCESS DENIED");
        serviceResponse.setErrors(Collections.singletonList(new ErrorDTO("", exception.getMessage())));
        return serviceResponse;
    }
}
